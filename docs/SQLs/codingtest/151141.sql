...
WITH TOTAL AS (SELECT HISTORY_ID, CAR_ID,  
                    CASE
                ...
                LEFT JOIN (SELECT CAR_TYPE, DURATION_TYPE, (1-DISCOUNT_RATE*0.01) AS RATE
                            FROM CAR_RENTAL_COMPANY_DISCOUNT_PLAN
                            WHERE CAR_TYPE = '트럭') AS CCDP
                ON CCRH.DURATION = CCDP.DURATION_TYPE
